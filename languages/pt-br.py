...
'Click on the link http://www.skytoop.com/Skytoop/default/user/reset_password/%(key)s to reset your password': 'Click on the link http://www.skytoop.com/Skytoop/default/user/reset_password/%(key)s to reset your password',
'Click on the link http://www.skytoop.com/Skytoop/default/user/verify_email/%(key)s to verify your email': 'Click on the link http://www.skytoop.com/Skytoop/default/user/verify_email/%(key)s to verify your email',
'Client IP': 'Client IP',
'Community': 'Community',
